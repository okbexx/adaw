...
| --- | --- | --- | --- | --- | --- |
| AC-P-1 | protocol | 作为用户，我在编辑器或文件浏览器里打开 active acceptance contract 后，能在 60 秒内看懂目标、分层验收标准、每条状态和当前缺口。 | passing | verified | test-summary: Acceptance contract renders goal, Capability Profile, layered ACs, status, and current gap in process/acceptance/active/adaw-self.acceptance.md. |
